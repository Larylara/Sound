            ...
            if(in_array($ext, $tab_ext)) {
                ...
                if($this->size < $this->max_size) {
                    ...
                    if($this->error === 0) {
                        ...
                        header("Location: /pages-controller/about?msg=Erreur de téléchargement");
                        exit();
                    }
                  
                } else {
                    header("Location: /pages-controller/about?msg=Fichier trop lourd");
                    exit();
                } 
 
            } else {
                header("Location: /pages-controller/about?msg=Cette extension n'est pas reconnue. Veuillez en définir une autre");
                exit();
            }
